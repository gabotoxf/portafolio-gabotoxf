...
export default function Loader() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-background-dark flex flex-col items-center justify-center">
      {/* Background Glow */}
      ...
      <div className="relative flex flex-col items-center justify-center">
        ...
        <div className="flex items-center mb-8 animate-in fade-in zoom-in duration-1000">
          <span className="text-5xl font-black text-accent-lime font-mono">{"{"}</span>
